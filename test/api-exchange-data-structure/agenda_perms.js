...
// ##### GET
var get_object = tests_data.agenda_2;
var write_group = tests_data.group_2;
var write_user = tests_data.user_2;

var write_group_perm = tests_data.perms_agenda_2_write_group_2
var write_user_perm = tests_data.perms_agenda_2_write_user_2

var create_object = tests_data.agenda_3;

var delete_write_group_perm = tests_data.perms_agenda_3_write_group_2
var delete_write_user_perm = tests_data.perms_agenda_3_write_user_2
...
vows.describe('Agenda perms API exchanged data structure').addBatch({
	...
	'CREATE Write Group perm' : {
		topic : function() {
			rest = new Rest();
			rest.post('/perms/agenda/wg', JSON.stringify({grantTo : write_group.id, applyOn : create_object.id}), this.callback);
		},
	...
	'CREATE Write User perm' : {
		topic : function() {
			rest = new Rest();
			rest.post('/perms/agenda/wu', JSON.stringify({grantTo : write_user.id, applyOn : create_object.id}), this.callback);
		},
